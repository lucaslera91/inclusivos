...
let escala = document.getElementById('scale');
let letras = document.getElementById('letras');

function fcColor(){
document.body.style.backgroundColor = document.getElementById('scale').value;
}
function fcLetras(){
  document.body.style.color = document.getElementById('letras').value;
  }
  function fcFont(){
    document.body.style.fontSize = document.getElementById('font').value + 'px';
    }

//fondo.addEventListener('click', barra);
...
//     let selected = document.getElementsByTagName('body')[0];
